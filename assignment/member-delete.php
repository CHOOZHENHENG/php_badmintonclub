...
if (!empty($_POST)){
    ...
    $q = "DELETE FROM member_eb WHERE stud_id = '$stud_id'";
    ...
    if ($r){
        echo '<div style="background-color:#6CCA9B">'.
                      ...
                      '</div>'.
        '<p>[<a href="admin-member-list.php">Back to Member List</a>]</p>';
} else{
    echo '<div style="background-color:#6CCA9B">'.
...
$Event_registration_date = "";
    ...
    $q = "SELECT * FROM member_eb WHERE stud_id= '$stud_id'";
$r = mysqli_query($dbc, $q);
...
<html>
    <head>
         <title>Delete Member Information</title>
        <meta charset="UTF-8">
    ...
    <body>
        <div>
            ...
            ?>
                <br>
             <h1 style="color: blue">Delete Member</h1>
             <p>Are you sure you want to delete the following member?</p>
             <hr>
